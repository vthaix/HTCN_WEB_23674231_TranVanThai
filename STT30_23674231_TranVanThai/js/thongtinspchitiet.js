    ...
    const productHtml = `
        ...
        <div class="col-md-7">
            <div class="bg-white p-4 shadow rounded">
                ...
                <p class="text-danger fw-bold"><strong>Giá:</strong> ${product.price.toLocaleString()}đ</p>
...
const renderVPPDetail = (product, productId) => {
    const productListContainer = document.getElementById(productId);
    const productHtml = `
        <div class="col-md-5 text-center">
            <div class="product-card">
...
const renderButGhiDetail = (product, productId) => {
    const productListContainer = document.getElementById(productId);
    const productHtml = `
        <div class="col-md-5 text-center">
            <div class="product-card">
        ...
        <div class="col-md-7">
            <div class="bg-white p-4 shadow rounded">
                ...
                <p><strong>Nhà cung cấp:</strong> ${product.publisher}</p>
                <p><strong>Nơi sản xuất:</strong> ${product.region}</p>
                <p><strong>Số Lượng/Bộ:</strong> ${product.loai}</p>
                <p class="text-danger fw-bold"><strong>Giá:</strong> ${product.price.toLocaleString()}đ</p>
                <p><strong>Đánh giá:</strong>
                    <i class="bi bi-star-fill text-warning"></i>
                    <i class="bi bi-star-fill text-warning"></i>
...
window.onload = function() {
    ...
    else if (type === "vanphongpham") renderVPPDetail(product, containerId);
    else if (type == "butghi") renderButGhiDetail(product, containerId);
};